...
import LeadPerformanceChart from '@components/lead/LeadPerformanceChart';
...
const LiveOverview: React.FC<{
        ...
        leads.forEach(lead => {
            ...
            if (!dataMap.has(groupId)) {
                ...
                dataMap.set(groupId, {
                    groupName,
                    total: 0,
                    leadsByStatus: { 'Nuovo': [], 'Contattato': [], 'In Lavorazione': [], 'Perso': [], 'Vinto': [], 'Preventivo Inviato': [], 'Preventivo Accettato': [] }
                });
            }
    ...
    return (
        <div className="space-y-8">
            {/* New Lead Performance Chart */}
            <LeadPerformanceChart leads={leads} />
